...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.GraphicsViewBottomCenter = QtWidgets.QGraphicsView(self.centralwidget)
        self.GraphicsViewBottomCenter.setGeometry(QtCore.QRect(530, 340, 301, 241))
        self.GraphicsViewBottomCenter.setObjectName("GraphicsViewBottomCenter")
        self.GraphicsViewBottomLeft = QtWidgets.QGraphicsView(self.centralwidget)
        self.GraphicsViewBottomLeft.setGeometry(QtCore.QRect(230, 340, 291, 241))
        self.GraphicsViewBottomLeft.setObjectName("GraphicsViewBottomLeft")
        self.GraphicsViewBottomRight = QtWidgets.QGraphicsView(self.centralwidget)
        self.GraphicsViewBottomRight.setGeometry(QtCore.QRect(840, 340, 301, 241))
        self.GraphicsViewBottomRight.setObjectName("GraphicsViewBottomRight")
        self.GraphicsViewUpLeft = QtWidgets.QGraphicsView(self.centralwidget)
        self.GraphicsViewUpLeft.setGeometry(QtCore.QRect(230, 50, 451, 281))
        self.GraphicsViewUpLeft.setObjectName("GraphicsViewUpLeft")
        self.GraphicsViewUpRight = QtWidgets.QGraphicsView(self.centralwidget)
        self.GraphicsViewUpRight.setGeometry(QtCore.QRect(690, 50, 451, 281))
        self.GraphicsViewUpRight.setObjectName("GraphicsViewUpRight")
        ...
        self.GraphicsViewUpRight.raise_()
        self.GraphicsViewUpLeft.raise_()
        ...
        self.GraphicsViewBottomCenter.raise_()
        self.GraphicsViewBottomLeft.raise_()
        self.GraphicsViewBottomRight.raise_()
