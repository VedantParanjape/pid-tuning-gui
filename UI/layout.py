...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.RefreshPortButton.setGeometry(QtCore.QRect(600, 20, 41, 31))
        ...
        self.GraphicViewUpLeftLabel.setGeometry(QtCore.QRect(420, 90, 101, 19))
        ...
        self.GraphicViewBottomLeftLabel.setGeometry(QtCore.QRect(320, 380, 101, 19))
        ...
        self.GraphicViewBottomCenterLabel.setGeometry(QtCore.QRect(650, 380, 91, 19))
        ...
        self.GraphicViewUpRightLabel.setGeometry(QtCore.QRect(890, 90, 81, 19))
        ...
        self.GraphicViewBottomRightLabel.setGeometry(QtCore.QRect(940, 380, 101, 19))
        ...
        self.PortDropDownList.setGeometry(QtCore.QRect(380, 20, 211, 31))
        self.PortDropDownList.setObjectName("PortDropDownList")
        self.SerialPortOptionButton = QtWidgets.QRadioButton(self.centralwidget)
        self.SerialPortOptionButton.setGeometry(QtCore.QRect(240, 10, 111, 25))
        self.SerialPortOptionButton.setObjectName("SerialPortOptionButton")
        self.UDPPortOptionButton = QtWidgets.QRadioButton(self.centralwidget)
        self.UDPPortOptionButton.setGeometry(QtCore.QRect(240, 40, 124, 25))
        self.UDPPortOptionButton.setObjectName("UDPPortOptionButton")
        self.ConnectUDPPortButton = QtWidgets.QPushButton(self.centralwidget)
        self.ConnectUDPPortButton.setGeometry(QtCore.QRect(600, 20, 41, 31))
        icon = QtGui.QIcon.fromTheme("refresh")
        self.ConnectUDPPortButton.setIcon(icon)
        self.ConnectUDPPortButton.setObjectName("ConnectUDPPortButton")
        self.ServerAddressTextBox = QtWidgets.QLineEdit(self.centralwidget)
        self.ServerAddressTextBox.setGeometry(QtCore.QRect(380, 20, 211, 31))
        self.ServerAddressTextBox.setInputMethodHints(QtCore.Qt.ImhDigitsOnly|QtCore.Qt.ImhUrlCharactersOnly)
        self.ServerAddressTextBox.setInputMask("")
        self.ServerAddressTextBox.setText("")
        self.ServerAddressTextBox.setObjectName("ServerAddressTextBox")
        ...
        self.PortDropDownList.raise_()
        self.SerialPortOptionButton.raise_()
        self.UDPPortOptionButton.raise_()
        self.ConnectUDPPortButton.raise_()
        self.ServerAddressTextBox.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.GraphicViewUpLeftLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Current Plot</span></p></body></html>"))
        self.GraphicViewBottomLeftLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">P Term Plot</span></p></body></html>"))
        self.GraphicViewBottomCenterLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">I Term Plot</span></p></body></html>"))
        self.GraphicViewUpRightLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Error Plot</span></p></body></html>"))
        self.GraphicViewBottomRightLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">D Term Plot</span></p></body></html>"))
        self.SerialPortOptionButton.setText(_translate("MainWindow", "Serial Port"))
        self.UDPPortOptionButton.setText(_translate("MainWindow", "UDP Port"))
        self.ConnectUDPPortButton.setText(_translate("MainWindow", "C"))
