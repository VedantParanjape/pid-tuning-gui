...
QT_MOC_LITERAL(1, 12, 13), // "data_received"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 26), // "pid_terms_incomming_values"
QT_MOC_LITERAL(4, 54, 4) // "vals"

    },
    "datahandler\0data_received\0\0"
...
void datahandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->data_received((*reinterpret_cast< pid_terms_incomming_values(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (datahandler::*)(pid_terms_incomming_values );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&datahandler::data_received)) {
                *result = 0;
                return;
            }
        }
...
void *datahandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "boost::enable_shared_from_this<datahandler>"))
        return static_cast< boost::enable_shared_from_this<datahandler>*>(this);
...
// SIGNAL 0
void datahandler::data_received(pid_terms_incomming_values _t1)
{
